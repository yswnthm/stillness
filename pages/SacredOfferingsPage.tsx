                    ...
                    <div className="relative mb-60">
                        <div className="flex flex-col lg:flex-row items-center">
                            ...
                            <div className="w-full lg:w-2/5 lg:-ml-24 z-10 mt-12 lg:mt-0 reveal reveal-delay-2">
                                <div className="bg-white p-12 lg:p-20 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.1)] rounded-[3rem] border border-stone/5 relative group">
                                    ...
                                    <h3 className="text-4xl md:text-5xl font-serif mb-8">Curated Calm</h3>
                                    <p className="text-stone/60 leading-relaxed mb-10">
                                        A bespoke journey of 12 private in-home wellness sessions, evolving with your needs over the course of a year.
                                    </p>
                                    <Link
                                        to="/curated-calm"
                                        className="inline-flex items-center gap-4 text-stone group"
                                    >
                    ...
                    <div className="relative mb-40">
                        <div className="flex flex-col lg:flex-row-reverse items-center">
                            ...
                            <div className="w-full lg:w-2/5 lg:-mr-24 z-10 mt-12 lg:mt-0 reveal reveal-delay-2">
                                <div className="bg-midnightsea text-cream p-12 lg:p-20 shadow-2xl rounded-[3rem] border border-white/5 relative group">
                                    ...
                                    <h3 className="text-4xl md:text-5xl font-serif mb-8">The Stillness Habit</h3>
                                    <p className="text-cream/60 leading-relaxed mb-10">
                                        Join an intimate 30-day cohort for daily live-guided practice. Consistency becomes sacred when shared.
                                    </p>
                                    <Link
                                        to="/habit"
                                    ...
                                    >
                                        ...
                                        <span className="text-sm tracking-widest uppercase border-b border-transparent group-hover:border-cream transition-all duration-500 pb-1">View Cohorts</span>
                                    </Link>
                                </div>
                            </div>
                        </div>
