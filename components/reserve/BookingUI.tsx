      ...
      >
        ...
        <div className="lg:w-2/3 p-8 md:p-12 bg-white">
          <div className="flex justify-between items-center mb-12">
            <div>
              <h3 className="text-2xl font-serif text-midnightsea mb-1">Select a Date</h3>
              <p className="text-midnightsea/40 text-sm font-sans uppercase tracking-widest font-medium">March 2026</p>
            </div>
            <div className="flex gap-4">
              <button className="p-2 rounded-full border border-midnightsea/10 hover:bg-midnightsea hover:text-white transition-all">
                <ChevronLeft size={20} />
              </button>
              <button className="p-2 rounded-full border border-midnightsea/10 hover:bg-midnightsea hover:text-white transition-all">
          ...
          <div className="grid grid-cols-7 gap-2 md:gap-4 mb-4">
            ...
            {days.map(day => (
              <button
                ...
                className={`aspect-square flex items-center justify-center rounded-2xl text-sm transition-all duration-500 font-sans ${selectedDate === day
        ...
        <div className="lg:w-1/3 p-8 md:p-12 bg-cream/50 border-l border-stone/5">
          ...
          <div className="space-y-3">
            {timeSlots.map(time => (
              <button
                ...
                className={`w-full py-4 px-6 rounded-2xl text-sm font-bold tracking-widest uppercase transition-all duration-500 border ${selectedTime === time
                    ? 'bg-midnightsea text-cream border-midnightsea shadow-xl'
                    : 'bg-white text-midnightsea border-midnightsea/5 hover:border-seafoam hover:text-seafoam'
                  }`}
              >
                {time}
              </button>
          ...
          <div className="mt-12 pt-12 border-t border-stone/10">
            ...
            <p className="text-[10px] text-center text-midnightsea/40 mt-6 uppercase tracking-widest">No credit card required today</p>
          </div>
        </div>
      </motion.div>
    </div>
