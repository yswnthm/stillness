...
export const ClientLogos: React.FC = () => {
  return (
    <section className="py-12 bg-white border-y border-midnightsea/5">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <p className="text-center text-[10px] uppercase tracking-[0.3em] text-midnightsea/40 mb-10 font-bold">Trusted by forward-thinking teams</p>
